...
class Model {
     ...
     * @param  {Object} [relations={}]  Relations of the Model
     */
     ...
     * @param  {Object}  params  Parameters to be sent with the request
     * @param  {Boolean} [update_attributes=true]  Should the model update itself with the response
     *
     * @return {Promise}  API Progress
     */
     ...
     *
     * @return {(Collection<Model>|Model)}  Collection of Models or a Model
     */
     ...
     *
     * @return {(*|Model)}  Value requested or instance of the Model
     */
